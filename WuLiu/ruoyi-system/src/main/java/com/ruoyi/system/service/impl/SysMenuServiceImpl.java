...
public class SysMenuServiceImpl implements ISysMenuService
{
     ...
     */
    @Override
    public List<SysMenu> selectMenusByUser(SysUser user,Long homeId)
    {
        List<SysMenu> menus = new LinkedList<SysMenu>();
//        都显示所有菜单
        menus = menuMapper.selectMenuNormalAll( homeId);
//        // 管理员显示所有菜单信息
        if (user.isAdmin())
        {
            menus = menuMapper.selectMenuNormalAll( homeId);
        ...
        {
            menus = menuMapper.selectMenusByUserId(user.getUserId(), homeId);
        }
